...
/**
 * Inline PDF preview for tailored job résumés — prefers a blob URL from base64,
 * otherwise streams from the backend draft file (Node fs).
 */
export function JobResumePdfPreview({ applierName, jobId, base64, mimeType, className }: Props) {
...
/** @deprecated Prefer JobResumePdfPreview */
export const AgentResumePdfPreview = JobResumePdfPreview;

...
export const NAV_ITEMS: NavItem[] = [
  ...
  { id: "calendar", label: "Calendar", icon: Calendar, beta: true },
  { id: "notion", label: "Notion", icon: NotebookTabs, beta: true },
...
export const NAV_GROUPS: { label: string | null; ids: View[] }[] = [
  ...
  {
    label: "TOOLS",
    ids: ["agents", "mail", "calendar", "notion", "interviews", "bid-management", "apps-plugins", "firebase"],
  },

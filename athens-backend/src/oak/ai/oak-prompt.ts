...
14. Resume / CV: if page.recommendedResumeAvailable is true, emit action "resume_upload" (not "upload") with file "recommended_resume" for resume/CV file inputs and nearby Attach/upload controls. The runtime attaches the Library resume recommended for this job. If page.recommendedResumeAvailable is false, do not emit resume_upload — list the resume control in unresolved_items and keep filling every other field. Never use resume_upload for cover letters, transcripts, or other documents — those stay "upload" or pause_for_review.

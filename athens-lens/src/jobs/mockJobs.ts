...
export const MOCK_JOBS = [
  {
    ...
    postedAt: "2026-08-03",
    summary: "Shape clear, thoughtful experiences for teams doing complex work together.",
  ...
  },
  {
    ...
    employmentType: "Full-time",
    postedAt: "2026-08-02",
    summary: "Build a customer operations practice that turns insight into better service.",
  ...
  },
  {
    ...
    employmentType: "Full-time",
    postedAt: "2026-07-31",
    summary: "Help research teams plan, run, and share high-quality learning programs.",
  ...
  },
  {
    ...
    employmentType: "Full-time",
    postedAt: "2026-07-29",
    summary: "Create dependable financial operations for a growing organization.",
  ...
  },
  {
    ...
    employmentType: "Full-time",
    postedAt: "2026-07-27",
    summary: "Design thoughtful programs that help people do their best work together.",
  ...
  },
  {
    ...
    employmentType: "Full-time",
    postedAt: "2026-07-25",
    summary: "Set a clear editorial direction across a growing family of experiences.",
  ...
  },
  {
    ...
    employmentType: "Full-time",
    postedAt: "2026-07-22",
    summary: "Create a welcoming, well-run workplace where teams can connect and focus.",
  ...
  },
  {
    ...
    employmentType: "Full-time",
    postedAt: "2026-07-20",
    summary: "Turn open questions into structured analysis and practical next steps.",
